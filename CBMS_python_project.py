...
class user:
    ...
    def widgets(self):
        ...
        Entry(self.logf,textvariable = self.username,font = ('',15)).grid(row=0,column=1)
        Label(self.logf,text = 'Password: ',font = ('',20),pady=5,padx=5).grid(sticky = W)
        Entry(self.logf,textvariable = self.password,font = ('',15),show = '*').grid(row=1,column=1)
        ...
        Entry(self.crf,textvariable = self.n_username,font = ('',15)).grid(row=0,column=1)
        Label(self.crf,text = 'Password: ',font = ('',20),pady=5,padx=5).grid(sticky = W)
        Entry(self.crf,textvariable = self.n_password,font = ('',15),show = '*').grid(row=1,column=1)
...
class travel:
    ...
    #==========================================Define Functiom==================================================
        ...
        def Kilo():
            if var2.get() == 0:
                ...
                if varl1.get() == "LPU GATE":
                    switch ={"LPU ground": 10,"Department of CSE": 8,"UNI hospital":6,"LPU GATE": 0}
                    Km.set(switch[varl2.get()])
                elif varl1.get() == "LPU ground":
                    switch ={"LPU ground": 0,"Department of CSE": 2,"UNI hospital":5,"LPU GATE": 10}
                    Km.set(switch[varl2.get()])
                elif varl1.get() == "Department of CSE":
                    switch ={"LPU ground": 2,"Department of CSE": 0,"UNI hospital":3,"LPU GATE": 8}
                    Km.set(switch[varl2.get()])
                elif varl1.get() == "UNI hospital":
                    switch ={"LPU ground": 5,"Department of CSE": 3,"UNI hospital":0,"LPU GATE": 6}
                    Km.set(switch[varl2.get()])        
   ...
   #================================================mainframe========================================================================
    ...
    #================================================customerframedetail=============================================================
        CustomerDetailsFrame=LabelFrame(MainFrame, width=1350,height=500, pady=5, relief=RIDGE)
        CustomerDetailsFrame.pack(side=BOTTOM,fill=BOTH,expand=True)

        FrameDetails=Frame(CustomerDetailsFrame, width=880,height=400, relief=RIDGE)
        FrameDetails.pack(side=LEFT,fill=BOTH,expand=True)

        CustomerName=LabelFrame(FrameDetails, width=300,height=300,font=('arial',12,'bold'),text="Customer Info", relief=RIDGE)
        CustomerName.grid(row=0,column=0)

        TravelFrame = LabelFrame(FrameDetails, width=300,height=250, font=('arial',12,'bold'),text="Booking Detail", relief=RIDGE)
    ...
    #===============================================recipt======================================================================
        Receipt_BottonFrame=LabelFrame(CustomerDetailsFrame, width=450,height=400, relief=RIDGE)
    ...
    #=========================================================CustomerName====================================================
        ...
        self.lblFirstname=Label(CustomerName,font=('arial',14,'bold'),text="Firstname")
        self.lblFirstname.grid(row=0,column=0,sticky=W)
        self.txtFirstname=Entry(CustomerName,font=('arial',14,'bold'),textvariable=Firstname,insertwidth=2,justify=RIGHT)
        ...
        self.txtSurname=Entry(CustomerName,font=('arial',14,'bold'),textvariable=Surname,insertwidth=2,justify=RIGHT)
        ...
        self.txtAddress=Entry(CustomerName,font=('arial',14,'bold'),textvariable=Address,insertwidth=2,justify=RIGHT)
        self.txtAddress.grid(row=2,column=1)


        self.lblPostcode=Label(CustomerName,font=('arial',14,'bold'),text="Postcode")
        self.lblPostcode.grid(row=3,column=0,sticky=W)
        self.txtPostcode=Entry(CustomerName,font=('arial',14,'bold'),textvariable=Postcode,insertwidth=2,justify=RIGHT)
        self.txtPostcode.grid(row=3,column=1)


        self.lblTelephone=Label(CustomerName,font=('arial',14,'bold'),text="Telephone")
        self.lblTelephone.grid(row=4,column=0,sticky=W)
        self.txtTelephone=Entry(CustomerName,font=('arial',14,'bold'),textvariable=Telephone,insertwidth=2,justify=RIGHT)
        self.txtTelephone.grid(row=4,column=1)

        self.lblMobile=Label(CustomerName,font=('arial',14,'bold'),text="Mobile")
        self.lblMobile.grid(row=5,column=0,sticky=W)
        self.txtMobile=Entry(CustomerName,font=('arial',14,'bold'),textvariable=Mobile,insertwidth=2,justify=RIGHT)
        self.txtMobile.grid(row=5,column=1)

        self.lblEmail=Label(CustomerName,font=('arial',14,'bold'),text="Email")
        self.lblEmail.grid(row=6,column=0,sticky=W)
        self.txtEmail=Entry(CustomerName,font=('arial',14,'bold'),textvariable=Email,insertwidth=2,justify=RIGHT)
        self.txtEmail.grid(row=6,column=1)

 
    #===============================================Cab Information==============================================================
        self.lblPickup=Label(TravelFrame,font=('arial',14,'bold'),text="Pickup")
        ...
        self.cboPickup['value']=('','LPU GATE','UNI hospital','Department of CSE','LPU ground')
        self.cboPickup.current(0)
        self.cboPickup.grid(row=0,column=1)


        self.lblDrop=Label(TravelFrame,font=('arial',14,'bold'),text="Drop")
        ...
        self.cboDrop['value']=('','LPU ground','Department of CSE','LPU GATE','UNI hospital')
        self.cboDrop.current(0)
    ...
    #===============================================Cab Information==============================================================
        ...
        self.txtCabTax=Label(TravelFrame,font=('arial',14,'bold'),textvariable=CabTax,width=18,bg="white",state= DISABLED,justify=RIGHT,relief=SUNKEN)
        ...
        self.txtKm=Label(TravelFrame,font=('arial',14,'bold'),textvariable=Km,width=18,bg="white",state= DISABLED,justify=RIGHT,relief=SUNKEN,highlightthickness=0)
        ...
        self.txtTravel_Ins=Label(TravelFrame,font=('arial',14,'bold'),textvariable=Travel_Ins,width=18,bg="white",state= DISABLED,justify=RIGHT,relief=SUNKEN)
        ...
        self.txtLuggage=Label(TravelFrame,font=('arial',14,'bold'),textvariable=Luggage,width=18,bg="white",state= DISABLED,justify=RIGHT,relief=SUNKEN)
        self.txtLuggage.grid(row=6,column=1)
    
    #=================================payment information ===========================================================================
         
        self.lblPaidTax=Label(CostFrame,font=('arial',14,'bold'),text="Paid Tax\t\t")
        self.lblPaidTax.grid(row=0,column=2,sticky=W)
        self.txtPaidTax = Label(CostFrame,font=('arial',14,'bold'),textvariable=PaidTax, width=10, justify=RIGHT,bg="white",relief=SUNKEN)
        self.txtPaidTax.grid(row=0,column=3)
            

        
        self.lblSubTotal=Label(CostFrame,font=('arial',14,'bold'),text="Sub Total")
        self.lblSubTotal.grid(row=1,column=2,sticky=W)
        self.txtSubTotal = Label(CostFrame,font=('arial',14,'bold'),textvariable=SubTotal, width=10, justify=RIGHT,bg="white",relief=SUNKEN)
        self.txtSubTotal.grid(row=1,column=3)



        self.lblTotalCost=Label(CostFrame,font=('arial',14,'bold'),text="Total Cost")
        self.lblTotalCost.grid(row=2,column=2,sticky=W)
        self.txtTotalCost = Label(CostFrame,font=('arial',14,'bold'),textvariable=TotalCost, width=10, justify=RIGHT,bg="white",relief=SUNKEN)
    ...
    #==========================================================Cabselect=======================================================================
        ...
        self.txtStandard = Label(Book_Frame,font=('arial',14,'bold'),width =7,textvariable=Standard, state= DISABLED, justify=RIGHT,bg="white",relief=SUNKEN)
        ...
        self.txtFordGalaxy= Label(Book_Frame,font=('arial',14,'bold'),width =7,textvariable=FordGalaxy, state= DISABLED, justify=RIGHT,bg="white",relief=SUNKEN)
        ...
        self.txtFordMondeo = Label(Book_Frame,font=('arial',14,'bold'),width =7,textvariable=FordMondeo, state= DISABLED, justify=RIGHT,bg="white",relief=SUNKEN)
